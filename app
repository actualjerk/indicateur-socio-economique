...
DIMENSIONS = {
    "Revenus et inégalités": {
        ...
        "variables": {
            "Revenu médian": {
                "min": 20460, "max": 34765, "valeur": 25210, "unite": "€",
                "sens": "positif",
    ...
    "Éducation": {
        ...
        "variables": {
            "Part des diplômés du supérieur (15 ans+ non scolarisés)": {
                "min": 20.1, "max": 61.0, "valeur": 35.0, "unite": "%",
                "sens": "positif",
            ...
            "Part des actifs peu ou pas diplômés parmi les actifs": {
                "min": 6.2, "max": 22.8, "valeur": 20.0, "unite": "%",
                "sens": "negatif",
    ...
    "Emploi": {
        ...
        "variables": {
            "Taux de chômage au sens du recensement des 15-64 ans": {
                "min": 4.9, "max": 15.3, "valeur": 12.0, "unite": "%",
                "sens": "negatif",
                "source": "INSEE, RP 2021, base communale Emploi-Population active, Île-de-France",
